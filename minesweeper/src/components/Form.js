  ...
  return (
    <form style={style.form} onSubmit={handleSubmit}>
      <h1 class="message" style={{ fontSize: "5vh" }}>
        You are a Minesweeper Champion! Based on your time of {props.score}s on{" "}
        {difficulty}, your score is {Math.ceil(props.mines * props.col * props.row * (1000 - props.score))}
      </h1>
